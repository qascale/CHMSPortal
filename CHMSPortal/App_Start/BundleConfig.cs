    ...
    public class BundleConfig
    {
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new ScriptBundle("~/bundles/MasterLayout").Include(
                ...
                "~/Scripts/Project_Scripts/PageValidation.js",
            ...
            bundles.Add(new StyleBundle("~/bundles/nouslidercss").Include(
                "~/Vendor/slider/nouslider/jquery.nouislider.css"
            ));

            //PVC Script
            bundles.Add(new ScriptBundle("~/bundles/nouslider").Include(
                 "~/Vendor/slider/nouslider/jquery.nouislider.min.js",
                  "~/Scripts/pixastic.js"
            ));
            ...
            bundles.Add(new StyleBundle("~/bundles/datatablesCss")
              .Include("~/Vendor/datatables-colvis/css/dataTables.colVis.css")
              .Include("~/Vendor/datatables/media/css/dataTables.bootstrap.css")
              .Include("~/Vendor/dataTables.fontAwesome/index.css")
            );
            ...
            bundles.Add(new StyleBundle("~/bundles/CanvasCss").Include(
             "~/Vendor/canvas/canvasCrop.css"
            ));

            bundles.Add(new ScriptBundle("~/bundles/Canvas").Include(
              "~/Vendor/canvas/cropper.js",
               "~/Vendor/canvas/main.js"
